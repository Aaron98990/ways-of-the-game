...
- 🔴 Match-Changing Incorrect Call
  - VAR (if existed without competition option) would of intervened (Goal, Penalty Kick, Red Card including giving an incorrect second yellow card, Mistaken identity)
