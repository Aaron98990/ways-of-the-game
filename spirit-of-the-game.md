...
Many people call this Law 18, Common Sense, Trifling, Tradition, Unwritten Rules, Discretion or "in the opinion of the referee". This subjectivity is a blessing and a curse. 
...
These are common "spirit of the game" moments. There are no hard and fast guidelines on what the "spirit of the game" is but I divided these into three sections: Commonly Accepted, Subjective, and Not Commonly Acceptable.

## Commonly Accepted

Windy conditions mean that a ball can't be stationary on the ground although the restart requires the ball to be stationary.
...
- Referees do not end a half during a promising attack during a close game or if the ball is about to go in the goal as this is seen as the fairest for both teams. If there is a dangerous free kick, allow it to be taken esspecially if a card was given for the offense and its a close game. 
...
There is a higher standard to earn a second caution than the first caution. I am not saying to ignore it but if it is not a physcial challenge, try to manage it instead of a second caution. Borderline, barely, or any doubts means it is not worth a second caution. 

The bar for earning a caution or sending-off is a bit higher when the offense is punished with a penalty kick as the penalty kick is already a huge punishment. I am not saying to ignore it but if it is borderline - go down one level. 
...
- The referee does not have to give permission for a substituion if one is requested. Denying a substitution that is clearly time wasting or occurs too often is accepted. For games where competition rules mandate no added time, I would say this is expected. 

## Gray Area

A foul occurs by the defense barely in the penalty area and is barely a foul.
- For recreational soccer, rather than a penalty kick I have moved the foul right outside the penalty area since a penalty kick is too harsh. Both are accepted. 
...
- Some referees deem this as unsporting behavior. It's not wrong as a retaliation foul would be common after showboating like that. Personally, I would allow the play to continue. Both are supported and depends on your judgement. 
...
- For lower levels of football where the number of balls are limited and the main purpose is to have fun, I would show a yellow card for unsporting behavior after a verbal warning. Some say you can kick the ball wherever you want when its in play so both decisions are supported.

Ending the game on a corner kick during a close game. 
- If time is up, time is up. But for me if it is just a couple seconds after expiration, let them take it if it is done quickly.  Never say this is the last play - at most say under a minute. Both decisions can be supported. 
...
- For lower levels of the game, this may be acceptable as the main intent is to have fun. But any foul that is clearly reckless or uses excessive force should be sanctioned no mattered the scoreline or level of the game. Not properly sanctioning reckless/excessive force fouls emboldens other players to foul more and lessens the referee's authority.

Not giving a second yellow card for removing one's shirt during a goal celebration because it is harsh.
- A player does not accidentally remove their shirt - they know what they are doing. But, in lower levels, I don't think think this is worth a second yellow card. Both are accepted.
...
Not using cards in a "friendly", "scrimmage", "alumni", "warmup", or pre-season match or any other match that isn't part of a competition. 
- Cards are the main way for a referee to control a game. Referees are not like coaches who have other ways to punish non-desirable behavior from players. From my experience, friendly games are more aggressive than regular season games as coaches choose to play against teams that are at a similar skill level and players want to prove themselves for the games that matter.
...
- A referee can't omit a caution or send-off from their match report because of an apology or laziness (unless the match reporting system is insanely stupid/broken/complicated). A referee could of used their discretion before the caution or send-off.

Not awarding a clear penalty kick or red card for a physcial offense (including second yellow card) because you don't want the game decided like that.
