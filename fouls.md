...
Please use signals in the Laws or Guidelines for offenses/fouls, restarts, or misconduct. A thumbs up/down, shaking the flag while it's down, using your arm instead of the flag, or putting hand on badge/back pocket for misconduct or shaking your head  will be misinterpreted. For misconduct, raise the flag then have a conversation. If you signal, commit to the signal until referee waves you down  
