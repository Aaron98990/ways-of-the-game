...
During penalties unlike other parts of the match:
  ...
  - only players at the end of the match may take part except:
    - an injured goalkeeper may be replaced with a named substitue only if substitutions remain or an excluded player
...
- "Where's the card?" or "The referee does not give cards" or asking, not demanding for a card (the person wants the game called more tightly)
...
- non-soccer plays
  - certain holding plays
    ...
    - front holding when offender and offended are not stationary [Example 1](https://youtu.be/06lqnmddvKQ?feature=shared&t=614), [Example 2](https://youtu.be/jgveRUXYiSk?si=8CnUrOSlix8EoJsu&t=10)
